      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 items-start">
          ...
          <div className="md:col-span-4 flex flex-col gap-5">
            <Link href="/" className="flex items-center gap-2.5 group w-fit">
              <div className="w-10 h-10 rounded-full bg-brand-primary flex items-center justify-center text-white shadow-md group-hover:scale-105 group-hover:rotate-6 transition-[transform] duration-300 ease-out">
                <Flame className="w-6.5 h-6.5 fill-current text-white" />
              </div>
            ...
            <p className="text-[15px] text-white/60 leading-relaxed max-w-sm font-semibold">
            ...
            <div className="flex items-center gap-3 mt-1">
              <a href="#" className="w-10 h-10 rounded-full bg-brand-primary text-white flex items-center justify-center hover:scale-115 transition-transform duration-200 ease-out cursor-pointer" aria-label="Instagram">
              ...
              <a href="#" className="w-10 h-10 rounded-full bg-brand-primary text-white flex items-center justify-center hover:scale-115 transition-transform duration-200 ease-out cursor-pointer" aria-label="Facebook">
          ...
          <div className="md:col-span-3 flex flex-col gap-4">
            <h4 className="text-[21px] font-black uppercase tracking-wider text-brand-primary">Kitchen Hours</h4>
            <ul className="flex flex-col gap-3.5 text-[15px] font-bold tracking-wider text-white/70">
              ...
              <li className="flex justify-between border-t border-white/10 pt-3">
                <span className="text-[13px] leading-relaxed text-white/50 lowercase italic font-semibold">Table orders stop 30m before close.</span>
              </li>
            </ul>
          </div>
          ...
          <div className="md:col-span-3 flex flex-col gap-4">
            <h4 className="text-[21px] font-black uppercase tracking-wider text-brand-primary">Contact</h4>
            <ul className="flex flex-col gap-3.5 text-[15px] font-bold tracking-wider text-white/70">
              <li className="flex items-start gap-2.5">
                <MapPin className="w-5.5 h-5.5 text-brand-primary shrink-0 mt-0.5" />
                <span className="leading-relaxed">108 Artisan Avenue, Suite B,<br />Detroit, MI 48201</span>
              </li>
              <li className="flex items-center gap-2.5">
                <Phone className="w-5.5 h-5.5 text-brand-primary" />
                <span>+1 (313) 555-0145</span>
              </li>
              <li className="flex items-center gap-2.5">
                <Mail className="w-5.5 h-5.5 text-brand-primary" />
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4">
          <span className="text-[13px] text-white/50 tracking-wider">© {new Date().getFullYear()} D Town Pizza. All rights reserved.</span>
          <div className="flex items-center gap-6 text-[13px] text-white/50 font-semibold tracking-wider">
