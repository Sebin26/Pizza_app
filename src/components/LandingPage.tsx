  ...
  return (
    <div className="relative min-h-screen bg-brand-cream text-brand-dark overflow-x-hidden selection:bg-brand-primary/10 selection:text-brand-primary">
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(232,114,44,0.025)_0%,transparent_75%)]" />
        
        {/* Warm ambient light blobs */}
        <div className="absolute top-[10%] left-[65%] w-[50vw] h-[50vw] max-w-150 bg-linear-to-tr from-brand-primary/12 to-brand-gold/8 rounded-full blur-[120px] opacity-75" />
        <div className="absolute top-[40%] left-[-15%] w-[45vw] h-[45vw] max-w-125 bg-brand-primary/5 rounded-full blur-[100px]" />
        <div className="absolute bottom-[10%] right-[-5%] w-[40vw] h-[40vw] max-w-112.5 bg-linear-to-br from-brand-gold/10 to-brand-primary/5 rounded-full blur-[110px]" />
      </div>
      ...
      <section className="relative min-h-[calc(100vh-80px)] flex items-center pt-8 pb-16 px-4 sm:px-6 lg:px-8 z-10 overflow-hidden bg-brand-dark">
        ...
        <div className="absolute inset-0 bg-linear-to-r from-brand-dark/95 via-brand-dark/70 to-transparent z-10 pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center relative z-20">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center text-left gap-8">
            <motion.div
            ...
            >
              <div className="inline-flex items-center gap-2 px-4.5 py-2 rounded-full bg-brand-primary/10 border border-brand-primary/20 text-brand-primary text-sm font-extrabold uppercase tracking-widest w-fit">
                <Flame className="w-5 h-5 fill-current animate-pulse text-brand-primary" />
              ...
              <h1 className="text-5xl sm:text-6xl md:text-7xl font-black tracking-tight leading-[1.05] text-white">
                ...
                <span className="bg-linear-to-r from-brand-primary to-brand-gold bg-clip-text text-transparent">
                  Ready When You Are.
                </span>
              </h1>
              
              <p className="text-lg sm:text-xl text-white/90 leading-relaxed font-semibold max-w-xl">
            ...
            >
              <Link
                href="/?order=true"
                className="group relative flex items-center justify-center gap-2 px-9 py-5 bg-brand-primary hover:bg-brand-primary-dark text-white text-base font-extrabold rounded-2xl shadow-lg shadow-brand-primary/25 hover:shadow-xl hover:shadow-brand-primary/35 transition-[transform,background-color,box-shadow] duration-200 ease-out hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.97] overflow-hidden"
              >
                {/* Micro-glow effect */}
              ...
              <a
                ...
                className="group flex items-center justify-center gap-2 px-9 py-5 bg-white/10 hover:bg-white/20 border border-white/20 text-white backdrop-blur-xs text-base font-extrabold rounded-2xl shadow-xs transition-[transform,background-color,border-color,box-shadow] duration-200 ease-out hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.97]"
              >
                <span>View Menu</span>
              </a>
            </motion.div>
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="grid grid-cols-3 gap-6 pt-5 border-t border-white/15 max-w-lg"
            >
              <motion.div variants={{ hidden: { opacity: 0, y: 12 }, visible: { opacity: 1, y: 0, transition: { duration: 0.5, ease: [0.23, 1, 0.32, 1] } } }}>
                <span className="block text-3xl font-black text-brand-primary">Table #</span>
                <span className="text-sm font-bold text-white/70 uppercase tracking-wider">Tap to Order</span>
              </motion.div>
              <motion.div variants={{ hidden: { opacity: 0, y: 12 }, visible: { opacity: 1, y: 0, transition: { duration: 0.5, ease: [0.23, 1, 0.32, 1] } } }}>
                <span className="block text-3xl font-black text-brand-primary">900°F</span>
                <span className="text-sm font-bold text-white/70 uppercase tracking-wider">Wood Oven</span>
              </motion.div>
              <motion.div variants={{ hidden: { opacity: 0, y: 12 }, visible: { opacity: 1, y: 0, transition: { duration: 0.5, ease: [0.23, 1, 0.32, 1] } } }}>
                <span className="block text-3xl font-black text-brand-primary">5 Min</span>
                <span className="text-sm font-bold text-white/70 uppercase tracking-wider">Fast Service</span>
              </motion.div>
            </motion.div>
          </div>

          {/* Right column remains empty on desktop to show background slideshow */}
      ...
      <section id="featured-pizzas" className="py-24 px-4 sm:px-6 lg:px-8 bg-white border-t border-brand-dark/5 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center flex flex-col items-center gap-4 mb-16">
            <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-brand-gold/15 text-brand-gold text-sm font-extrabold uppercase tracking-wider">
              Signature Pies
            </span>
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-brand-dark tracking-tight">
              Chef’s Handcrafted Selections
            </h2>
            <p className="text-lg sm:text-xl text-brand-dark/70 max-w-2xl leading-relaxed font-semibold">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-brand-cream border-t border-brand-dark/5 relative z-10">
        <div className="max-w-7xl mx-auto">
              {/* Header */}
          <div className="text-center flex flex-col items-center gap-4 mb-16">
            <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-brand-primary/10 text-brand-primary text-sm font-extrabold uppercase tracking-wider">
              The Artisan Standard
            </span>
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-brand-dark tracking-tight">
              The Craft Behind The Crust
            </h2>
            <p className="text-lg sm:text-xl text-brand-dark/70 max-w-xl leading-relaxed font-semibold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="w-14 h-14 rounded-2xl bg-emerald-500/10 text-emerald-600 flex items-center justify-center group-hover:rotate-12 transition-transform duration-300 ease-out">
                <Leaf className="w-7 h-7" />
              </div>
              <h3 className="text-2xl font-extrabold text-brand-dark">Fresh Ingredients</h3>
              <p className="text-base text-brand-dark/75 leading-relaxed font-semibold">
            ...
            <motion.div
              ...
              className="bg-white p-8 rounded-3xl shadow-xs border border-brand-dark/5 flex flex-col gap-6 group hover:-translate-y-1 hover:shadow-md transition-[transform,box-shadow] duration-300 ease-out"
            >
              <div className="w-14 h-14 rounded-2xl bg-brand-primary/10 text-brand-primary flex items-center justify-center group-hover:rotate-12 transition-transform duration-300 ease-out">
                <Clock className="w-7 h-7" />
              </div>
              <h3 className="text-2xl font-extrabold text-brand-dark">Fast Preparation</h3>
              <p className="text-base text-brand-dark/75 leading-relaxed font-semibold">
            ...
            >
              ...
              <h3 className="text-2xl font-extrabold text-brand-dark">Authentic Recipe</h3>
              <p className="text-base text-brand-dark/75 leading-relaxed font-semibold">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-white border-t border-brand-dark/5 relative z-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <motion.div 
            ...
            className="lg:col-span-5 relative w-full aspect-square max-w-120 mx-auto rounded-4xl overflow-hidden shadow-2xl border border-brand-dark/10 group"
          >
            {/* Overlay border design */}
            <div className="absolute inset-4 rounded-3xl border border-white/20 z-10 pointer-events-none" />
          ...
          <div className="lg:col-span-7 flex flex-col gap-6 text-left">
            <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-brand-primary/10 text-brand-primary text-sm font-extrabold uppercase tracking-wider w-fit">
              Master Pizzaiolo
            </span>
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-brand-dark tracking-tight leading-tight">
              A Sourdough Secret,<br />Passed Down for Generations
            </h2>
            <div className="h-0.5 w-16 bg-brand-primary rounded-full my-1"></div>
            
            <div className="flex flex-col gap-4 text-lg sm:text-xl text-brand-dark/85 leading-relaxed font-semibold">
              <p>
            ...
            <div className="pt-2">
              ...
              <span className="text-sm font-extrabold text-brand-primary uppercase tracking-wider">Founder & Head Chef</span>
            </div>

            <div className="pt-4">
              <Link
                href="/?order=true"
                className="group inline-flex items-center gap-2 px-7 py-4 bg-brand-dark hover:bg-brand-primary text-white font-extrabold rounded-xl text-base transition-[background-color,transform,box-shadow] duration-200 ease-out active:scale-[0.97] shadow-xs hover:shadow-md cursor-pointer"
              >
                <span>Discover Chef Specials</span>
                <ArrowUpRight className="w-5.5 h-5.5 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform duration-200 ease-out" />
              </Link>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="flex flex-col gap-4">
                ...
                <p className="text-base font-semibold text-brand-dark/95 italic leading-relaxed">
              ...
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full bg-brand-primary/20 flex items-center justify-center font-black text-brand-primary text-base">
                  MA
                </div>
                <div>
                  <span className="block text-base font-bold text-brand-dark">Marco Andreoni</span>
                  <span className="block text-xs text-brand-dark/50 uppercase tracking-wider font-semibold">Table 4 Guest</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="block text-base font-bold text-brand-dark">Sarah Cole</span>
                  <span className="block text-xs text-brand-dark/50 uppercase tracking-wider font-semibold">Table 12 Guest</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full bg-brand-gold/20 flex items-center justify-center font-black text-brand-gold text-base">
                  DP
                </div>
                <div>
                  <span className="block text-base font-bold text-brand-dark">David Patel</span>
                  <span className="block text-xs text-brand-dark/50 uppercase tracking-wider font-semibold">Takeout Guest</span>
                </div>
              </div>
            </motion.div>
