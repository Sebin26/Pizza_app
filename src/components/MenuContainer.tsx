      ...
      <div className="flex flex-col md:flex-row gap-4 justify-between items-center bg-white p-4 rounded-2xl shadow-xs border border-brand-dark/5">
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-2.5 rounded-xl bg-brand-light text-brand-dark text-sm placeholder-brand-dark/40 border-0 focus:ring-2 focus:ring-brand-red/20 focus:bg-white transition-all duration-200"
          />
        </div>
          ...
          >
            {activeItems.map((item) => (
              <motion.div
                ...
                className="bg-white rounded-2xl overflow-hidden shadow-xs hover:shadow-md border border-brand-dark/5 flex flex-col justify-between"
              >
                {/* Visual Header */}
                ...
                <div className="p-6 flex flex-col flex-1 gap-4 justify-between">
                  <div className="flex flex-col gap-1.5">
                    <div className="flex justify-between items-start">
                      <h3 className="text-[17px] font-bold text-brand-dark leading-snug hover:text-brand-red transition-colors">
                        {item.name}
                      </h3>
                  ...
                  <div className="mt-2">
                    {item.isPizza ? (
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-brand-red hover:bg-brand-red/90 text-white font-bold text-sm shadow-sm hover:shadow-md transition-all active:scale-98"
                      >
                        Customize Pizza
                      </button>
                    ) : (
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-brand-light hover:bg-brand-dark hover:text-white text-brand-dark font-bold text-sm transition-all active:scale-98"
                      >
                        Add to Cart
                      </button>
                    )}
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              <div className="p-6 flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    maxLength={150}
                    rows={3}
                    className="w-full p-3.5 rounded-xl bg-brand-light text-brand-dark text-sm placeholder-brand-dark/40 border-0 focus:ring-2 focus:ring-brand-red/20 focus:bg-white resize-none transition-all duration-200"
                  />
              ...
              <div className="flex items-center gap-3 p-6 bg-brand-light border-t border-brand-dark/5 justify-end">
                <button
                  onClick={handleCloseQuantity}
                  className="px-5 py-2.5 rounded-xl hover:bg-brand-dark/5 text-brand-dark font-bold text-sm transition-colors"
                >
                  Cancel
                </button>
                <button
                  onClick={handleAddToCart}
                  className="flex items-center gap-2 px-6 py-2.5 rounded-xl bg-brand-red hover:bg-brand-red/90 text-white font-bold text-sm shadow-md shadow-brand-red/20 transition-all active:scale-95"
                >
